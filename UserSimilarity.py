...
COS_result = pd.DataFrame(COS(MovieLens_pivot)) # 결과 행렬을 보기 쉽게 데이터프레임으로 변환
...
PCC_result = pd.DataFrame(PCC(MovieLens_pivot)) # 결과 행렬을 보기 쉽게 데이터프레임으로 변환
...
JMSD_result = pd.DataFrame(JMSD(MovieLens_pivot, 5)) # 결과 행렬을 보기 쉽게 데이터프레임으로 변환
